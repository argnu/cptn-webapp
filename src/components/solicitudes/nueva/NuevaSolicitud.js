...
export default {
  ...
  methods: {
    ...
    addContacto: function () {
      if (this.nuevo_contacto.tipo === 1) {
        this.nuevo_contacto.valor = `+${this.nuevo_telefono.pais}-${this.nuevo_telefono.provincia}-${this.nuevo_telefono.numero}`;
      }
      else if (this.nuevo_contacto.tipo === 2) {
        this.nuevo_contacto.valor = '+' + this.nuevo_telefono.pais + '9' + this.nuevo_telefono.provincia + this.nuevo_telefono.numero;
      }
